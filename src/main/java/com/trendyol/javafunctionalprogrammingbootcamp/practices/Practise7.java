...
public class Practise7 {
    ...
    public boolean isReconciliationCompletedForGivenDateRange(
        ...
        return payments.stream().filter(payment -> payment.getCreatedDate() >= startDate && payment.getCreatedDate() <= endDate).allMatch(payment -> payment.isReconciliationCompleted());
    }
}
